...
TypeAST *parse_factor() {
    ...
    printf("Factor type: %s, value: %s, address: %s\n", LLVMPrintTypeToString(typeAST->typeRef), LLVMPrintValueToString(typeAST->valueRef), LLVMPrintValueToString(typeAST->address));
    return typeAST;
}
